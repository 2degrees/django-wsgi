# -*- coding: utf-8 -*-
#
# django-wsgi documentation build configuration file, created by
...
htmlhelp_basename = 'djangowsgidoc'
...
latex_documents = [
  ('index', 'djangowsgi.tex', u'django-django_wsgi Documentation',
